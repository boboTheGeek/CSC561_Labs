...
public class NoWeaponState extends ActionState
{
		...
		/**
		 * Lifeform tries to pickup a weapon if one exists in the cell it's currently in otherwise
		 * it changes the direction it's facing and goes on to search in that direction until end of the grid
		 */
		public void search() throws RException
		{
			...
			else
			{
				...
				if(currentDirection != randomDirectionPicked)
				{
					...
					{
						/**
						 * When direction is North and currentLocation = (5, 6), it goes to search down the grid 
						 * at locations (4, 6), (3, 6)...until it reaches the end cell
						 * in that direction
						 */
						j = loc[1];
						{
					...
					{
						/**
						 * When direction is South and currentLocation = (5, 6), it goes to search down the grid 
						 * at locations (6, 6), (7, 6)...until it reaches the end cell
						 * in that direction
						 */
					...
					{
						/**
						 * When direction is East and currentLocation = (5, 6), it goes to search down the grid 
						 * at locations (5, 7), (5, 8)...until it reaches the end cell
						 * in that direction
						 */
						i = loc[0];
						{
					...
					{
						/**
						 * When direction is West and currentLocation = (5, 6), it goes to search down the grid 
						 * at locations (5, 5), (5, 4)...until it reaches the end cell
						 * in that direction
						 */
						i = loc[0];
						{
	...
	/**
	 * Pick a random direction for the lifeform to turn and go ahead with search for weapon
	 * @return
	 */
